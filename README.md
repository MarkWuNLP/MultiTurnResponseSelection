...
<br>
As far as we known, this is the first human-labeled test set for retrieval-based chatbots. Please email me (wumark@126.com) if you need the entire corpus, and write your name, affiliation, and purpose. 
